...
v1.8.0 → v1.9.0:
  ...
  - TD-026..TD-038 — 13 deferred capabilities
...
═══════════════════════════════════════════════════════
  ...
  Детали TD-026..TD-038: см. MASTER_PLAN_PATCH_v1_9_0.md
...
═══════════════════════════════════════════════════════
  ...
  3. MASTER_PLAN v1.9.0 — стратегия, принципы, инварианты
  4. EXECUTION_ROADMAP v2.3 — операционный план и текущие модели
  5. MASTER_PLAN_PATCH_v1_9_0.md — детали изменений v1.9.0
