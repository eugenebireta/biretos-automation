# Research Brief — 36204-RU

**Priority:** low | **Reason:** no_price_lineage
**Goal:** Close unresolved enrichment gaps for PN 36204-RU (Honeywell)

## Known Facts
- Brand: Honeywell
- Name: Перекрестный соединитель 200x80мм 36204-RU
- Expected Category: Соединитель
- Our Price (xlsx): 3716,00

## Questions to Resolve
- Find a public market price for Honeywell 36204-RU from a verifiable distributor
- Is 36204-RU RFQ-only or available with published pricing?
- Which authorized distributors carry this part number?
- Provide any relevant Russian-language product description for Honeywell 36204-RU
