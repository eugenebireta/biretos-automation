# Research Brief — PROFI-O

**Priority:** high | **Reason:** no_price_lineage
**Goal:** Close unresolved enrichment gaps for PN PROFI-O (Honeywell)

## Known Facts
- Brand: Honeywell
- Name: Дымовой извещатель PROFI-O
- Expected Category: Извещатель
- Our Price (xlsx): 2187,68

## Questions to Resolve
- Find a public market price for Honeywell PROFI-O from a verifiable distributor
- Is PROFI-O RFQ-only or available with published pricing?
- Which authorized distributors carry this part number?
- Provide any relevant Russian-language product description for Honeywell PROFI-O
