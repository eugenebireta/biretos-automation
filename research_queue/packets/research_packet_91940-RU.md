# Research Brief — 91940-RU

**Priority:** high | **Reason:** no_price_lineage
**Goal:** Close unresolved enrichment gaps for PN 91940-RU (Honeywell)

## Known Facts
- Brand: Honeywell
- Name: Гибкая гофрированная труба Honeywell (в метрах)
- Expected Category: Труба
- Our Price (xlsx): 49,41

## Questions to Resolve
- Find a public market price for Honeywell 91940-RU from a verifiable distributor
- Is 91940-RU RFQ-only or available with published pricing?
- Which authorized distributors carry this part number?
- Provide any relevant Russian-language product description for Honeywell 91940-RU
