# Research Brief — 36299-RU

**Priority:** high | **Reason:** no_price_lineage
**Goal:** Close unresolved enrichment gaps for PN 36299-RU (Honeywell)

## Known Facts
- Brand: Honeywell
- Name: Адаптер RRC Honeywell 36299-RU, 400x200мм
- Expected Category: Адаптер
- Our Price (xlsx): 4161,50

## Questions to Resolve
- Find a public market price for Honeywell 36299-RU from a verifiable distributor
- Is 36299-RU RFQ-only or available with published pricing?
- Which authorized distributors carry this part number?
- Provide any relevant Russian-language product description for Honeywell 36299-RU
