# Research Brief — AT-MMCR18-60-RU

**Priority:** high | **Reason:** no_price_lineage
**Goal:** Close unresolved enrichment gaps for PN AT-MMCR18-60-RU (Honeywell)

## Known Facts
- Brand: Honeywell
- Name: Шасси Allied Telesis AT-MMCR18-60-RU
- Expected Category: Шасси
- Our Price (xlsx): 52788,50

## Questions to Resolve
- Find a public market price for Honeywell AT-MMCR18-60-RU from a verifiable distributor
- Is AT-MMCR18-60-RU RFQ-only or available with published pricing?
- Which authorized distributors carry this part number?
- Provide any relevant Russian-language product description for Honeywell AT-MMCR18-60-RU
