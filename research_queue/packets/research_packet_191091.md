# Research Brief — 191091

**Priority:** high | **Reason:** category_mismatch
**Goal:** Close unresolved enrichment gaps for PN 191091 (Honeywell)

## Known Facts
- Brand: Honeywell
- Name: Детектор пламени Honeywell D 20.674.221.192
- Expected Category: Детектор
- Our Price (xlsx): 12641,00

## Questions to Resolve
- What is the correct product category for Honeywell 191091 (Детектор пламени Honeywell D 20.674.221.192)?
- Is the expected category 'Детектор' correct for this product?
- What similar part numbers exist in the same product family?
- Provide any relevant Russian-language product description for Honeywell 191091
...
```json
{
  ...
  "price_source_url": "https://www.conrad.fr/fr/p/peha-by-honeywell-cadre-cadre-noir-191091-5-pc-s-2856835.html",
