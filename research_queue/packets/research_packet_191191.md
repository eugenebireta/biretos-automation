# Research Brief — 191191

**Priority:** high | **Reason:** category_mismatch
**Goal:** Close unresolved enrichment gaps for PN 191191 (Honeywell)

## Known Facts
- Brand: Honeywell
- Name: Детектор пламени Honeywell D 20.674.222.022
- Expected Category: Детектор
- Our Price (xlsx): 12641,00

## Questions to Resolve
- What is the correct product category for Honeywell 191191 (Детектор пламени Honeywell D 20.674.222.022)?
- Is the expected category 'Детектор' correct for this product?
- What similar part numbers exist in the same product family?
- Provide any relevant Russian-language product description for Honeywell 191191
...
```json
{
  ...
  "price_source_url": "https://liveinlight.ru/ramki/ramki-4-posta/ramka-4-posta-peha-by-honeywell-nova-titan",
