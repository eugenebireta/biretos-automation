# Research Brief — KD-050

**Priority:** high | **Reason:** no_price_lineage
**Goal:** Close unresolved enrichment gaps for PN KD-050 (Honeywell)

## Known Facts
- Brand: Honeywell
- Name: Лампа KD-050
- Expected Category: Лампа
- Our Price (xlsx): 0,00

## Questions to Resolve
- Find a public market price for Honeywell KD-050 from a verifiable distributor
- Is KD-050 RFQ-only or available with published pricing?
- Which authorized distributors carry this part number?
- Provide any relevant Russian-language product description for Honeywell KD-050
