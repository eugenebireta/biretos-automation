# Research Brief — TRAY-3

**Priority:** high | **Reason:** no_price_lineage
**Goal:** Close unresolved enrichment gaps for PN TRAY-3 (Honeywell)

## Known Facts
- Brand: Honeywell
- Name: Сплайс-бокс Honeywell TRAY-3
- Expected Category: Сплайс-бокс
- Our Price (xlsx): 4255,86

## Questions to Resolve
- Find a public market price for Honeywell TRAY-3 from a verifiable distributor
- Is TRAY-3 RFQ-only or available with published pricing?
- Which authorized distributors carry this part number?
- Provide any relevant Russian-language product description for Honeywell TRAY-3
