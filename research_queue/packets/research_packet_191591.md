# Research Brief — 191591

**Priority:** high | **Reason:** category_mismatch
**Goal:** Close unresolved enrichment gaps for PN 191591 (Honeywell)

## Known Facts
- Brand: Honeywell
- Name: Детектор пламени Honeywell D 20.674.240.192
- Expected Category: Детектор
- Our Price (xlsx): 7521,67

## Questions to Resolve
- What is the correct product category for Honeywell 191591 (Детектор пламени Honeywell D 20.674.240.192)?
- Is the expected category 'Детектор' correct for this product?
- What similar part numbers exist in the same product family?
- Provide any relevant Russian-language product description for Honeywell 191591
...
```json
{
  ...
  "price_source_url": "https://teslatorg.ru/elektroustanovochnye-izdeliya/rozetki-i-vyklyuchateli/ramki-dlya-rozetok-i-vyklyuchateley/ramka-4-posta-peha-by-honeywell-nova-bezuprechnyy-oniks-191591",
