# Research Brief — 187591

**Priority:** high | **Reason:** category_mismatch
**Goal:** Close unresolved enrichment gaps for PN 187591 (Honeywell)

## Known Facts
- Brand: Honeywell
- Name: Детектор пламени Honeywell D 20.672.243.022
- Expected Category: Детектор
- Our Price (xlsx): 3348,83

## Questions to Resolve
- What is the correct product category for Honeywell 187591 (Детектор пламени Honeywell D 20.672.243.022)?
- Is the expected category 'Детектор' correct for this product?
- What similar part numbers exist in the same product family?
- Provide any relevant Russian-language product description for Honeywell 187591
...
```json
{
  ...
  "price_source_url": "https://www.conrad.sk/sk/p/peha-by-honeywell-ramcek-ram-biela-187591-2856627.html",
