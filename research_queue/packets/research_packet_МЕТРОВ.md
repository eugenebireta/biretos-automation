# Research Brief — МЕТРОВ

**Priority:** high | **Reason:** no_price_lineage
**Goal:** Close unresolved enrichment gaps for PN МЕТРОВ (Honeywell)

## Known Facts
- Brand: Honeywell
- Name: Кабель Honeywell МЕТРОВ
- Expected Category: Кабель
- Our Price (xlsx): 0,00

## Questions to Resolve
- Find a public market price for Honeywell МЕТРОВ from a verifiable distributor
- Is МЕТРОВ RFQ-only or available with published pricing?
- Which authorized distributors carry this part number?
- Provide any relevant Russian-language product description for Honeywell МЕТРОВ
