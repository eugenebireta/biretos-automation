# Research Brief — P400-RU

**Priority:** high | **Reason:** no_price_lineage
**Goal:** Close unresolved enrichment gaps for PN P400-RU (Honeywell)

## Known Facts
- Brand: Honeywell
- Name: Видеокарта NVIDIA Quadro P400-RU
- Expected Category: Видеокарта
- Our Price (xlsx): 12231,00

## Questions to Resolve
- Find a public market price for Honeywell P400-RU from a verifiable distributor
- Is P400-RU RFQ-only or available with published pricing?
- Which authorized distributors carry this part number?
- Provide any relevant Russian-language product description for Honeywell P400-RU
