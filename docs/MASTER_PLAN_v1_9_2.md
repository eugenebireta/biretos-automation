...
═══════════════════════════════════════════════════════
GOVERNED AI EXECUTION LAYER (НОВОЕ в v1.9.2)
═══════════════════════════════════════════════════════

  AI coding agents = governed execution assistants, не owners of truth.
  LOW: semi-autonomous внутри guardrails.
  SEMI: commit/merge только с owner approval.
...
═══════════════════════════════════════════════════════
  ...
  TD-044: Portable Guard Validation → Review: при смене рабочей станции
  TD-045: SEMI Approval Artifact → Review: после CORE-APPROVED gate
  TD-046: Workstation Cutover Runbook → Review: при смене рабочей станции
  TD-047: Authoritative Security Gate cleanup → Review: после CORE-APPROVED gate
...
═══════════════════════════════════════════════════════
  ...
  3. MASTER_PLAN v1.9.2 — стратегия, принципы, инварианты
